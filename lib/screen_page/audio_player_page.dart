...
import 'package:lat_list_audio/model/model_audio.dart';
...
class _PageLatAudioState extends State<PageLatAudio> {
  ...
  Future<void> _fetchAudioData() async {
    try {
      final response = await http.get(Uri.parse('http://10.126.15.115/playlist_audio/getAudio.php'));
  ...
  void _play(int index) async {
    final audioUrl = 'http://10.126.15.115/playlist_audio/audio_file/${_audioList[index].audioFile}';
    try {
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                  'http://10.126.15.115/playlist_audio/gambar/${_audioList[index].gambar}',
                                ),
                                fit: BoxFit.cover,
                              ),
                            ),
